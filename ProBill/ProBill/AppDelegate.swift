...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    fileprivate func insert() {
        ...
        for cat in cats {
            let category: Category = NSEntityDescription.insertNewObject(forEntityName: "Category", into: self.managedObjectContext) as! Category
            category.name = cat
            
            let subCategory: SubCategory = NSEntityDescription.insertNewObject(forEntityName: "SubCategory", into: self.managedObjectContext) as! SubCategory
    ...
    fileprivate func fetch() {
        ...
        let fetch = NSFetchRequest<NSFetchRequestResult>(entityName: "Bill")
 ...
 */
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.yseemonnier.ProBill" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "ProBill", withExtension: "momd")!
